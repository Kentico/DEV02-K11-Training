<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ScheduleAppointmentEx3.ascx.cs" Inherits="CMSWebParts_DoctorAppointments_ScheduleAppointmentEx3" %>
...
<div class="ui raised very padded text container segment">
    ...
    <asp:PlaceHolder runat="server" ID="plcAppointmentForm">
        <div class="ui form">
            ...
            <div class="field">
                <label>Doctor*</label>
                <asp:DropDownList runat="server" ID="SelectDoctor" AutoPostBack="true" CssClass="ui dropdown SelectDoctor" EnableViewState="true" OnSelectedIndexChanged="SelectDoctor_SelectedIndexChanged">
